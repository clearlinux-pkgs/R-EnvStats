...
Version  : 3.1.0
Release  : 61
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/EnvStats_3.1.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/EnvStats_3.1.0.tar.gz
...
%setup -q -n EnvStats
pushd ..
cp -a EnvStats buildavx2
popd
pushd ..
cp -a EnvStats buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745599102
...
/usr/lib64/R/library/EnvStats/tinytest/test_enparCensored.R
...
/usr/lib64/R/library/EnvStats/tinytest/test_stats_test_text.R
